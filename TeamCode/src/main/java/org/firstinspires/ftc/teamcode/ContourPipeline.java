...
public class ContourPipeline extends OpenCvPipeline {
    ...
    // Duck Yellow                        Y      Cr     Cb    (Do not change Y)
    public static Scalar scalarLowerYCrCb = new Scalar(0.0, 141.0, 0.0);
    public static Scalar scalarUpperYCrCb = new Scalar(255.0, 120.0, 120.0);

    // Scorpio Red!
    //public static Scalar scalarLowerYCrCb = new Scalar(0.0, 240.0, 90.0);
